...
def create_database(system, dbName, forRawData="postgres"):
    ...
    try:
        ...
        DbSession,_,engine = appPaaS.getDbSessionType(dbName=default_dbName,forRawData=forRawData,system=system)
        print "~~~~~~~~~~"
        print DbSession
        print engine
        if DbSession is None:
...
__all__ = [
    ...
    'check_post_parameter_exist','retrieve_database_exist',
    ...
    'decorator_check_content_type','docstring_parameter',
