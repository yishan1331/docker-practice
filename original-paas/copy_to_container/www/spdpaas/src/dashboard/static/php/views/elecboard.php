...
function MainQuery($params)//主要查詢按鈕
{
    ...
    // $group = $this_group;
    $device_name = 'F11';
    $device_modal = $this_device_data['device_modal'];
    ...
    }
{
    ...
    if (!empty($test_vibMotor['QueryTableData'])) {
        ...
        // }
        $vibMotor_data = array(
            array("name" => "X軸", "stand" => array("value" => 3.5, "symbols" => "<"), "value" => array("value" => $test_vibMotor['QueryTableData'][0]['vibspeed_x'], "unit" => ' mm/s')),
            array("name" => "Y軸", "stand" => array("value" => 3.5, "symbols" => "<"), "value" => array("value" => $test_vibMotor['QueryTableData'][0]['vibspeed_y'], "unit" => ' mm/s')),
            array("name" => "Z軸", "stand" => array("value" => 2.8, "symbols" => "<"), "value" => array("value" => $test_vibMotor['QueryTableData'][0]['vibspeed_z'], "unit" => ' mm/s'))
        );
    }
    $teble = 'test_loadCell';
