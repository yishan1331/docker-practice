...
from dbModel.sapidosystem import Department,genRawDBName
import globalvar
import modules
# import web_utility
...
# FOR MYSQL
#=======================================================
# {{{ app.route('/api/<SYSTEM>/1.0/my/department/registerDep', methods = ['POST'])
...
# FOR MYSQL
#=======================================================
# {{{ app.route('/api/<SYSTEM>/1.0/my/department/update_Department', methods = ['PATCH'])
