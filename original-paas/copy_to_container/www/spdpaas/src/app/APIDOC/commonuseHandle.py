...
def commonuse_get_sqlsyntax_joinmultitable_():
    ...
    try:
        ...
        sqlsyntax_actions_status,sqlsyntax_actions_result = join_modules.sqlsyntax_params_actions(action_result,"condition_1",reqdataDict,sess,metadata,"mysql",True,"APIDOC")
        if not sqlsyntax_actions_status:
            dicRet["Response"] = sqlsyntax_actions_result
            return jsonify( **dicRet)
...
#        appPaaS.sessionLogger_APIDOC('Error','in Get Session, []: {}\n'.format(err_msg))
#        appPaaS.sessionLogger_APIDOC('Error','get_session_id() check parameter fail. {}\n'.format(err_msg))
#    else:
...
#            appPaaS.sessionLogger_APIDOC('Error','get_session_id(): {}\n'.format(err_msg))
#            appPaaS.sessionLogger_APIDOC('Error','client sent request.args:{}\n'.format(request.args))
#            appPaaS.sessionLogger_APIDOC('Error','string_to_sign = {}\n'.format(string_to_sign))
#            appPaaS.sessionLogger_APIDOC('Error','server calcaluted sign is {}\n'.format(cal_signature))
#            appPaaS.sessionLogger_APIDOC('Error','client sent sign is {}\n'.format(request.args['signature'] ))
#
...
#            appPaaS.sessionLogger_APIDOC('Error',strDebugMsg)
